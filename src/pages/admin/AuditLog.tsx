                ...
                <tr key={r.id}
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-foreground truncate max-w-[160px]">{actorName(r.actor_id)}</span>
                    </div>
                  </td>
                  <td className="p-3">
                  ...
                  <td className="p-3 text-xs text-muted-foreground truncate max-w-[140px]">{tenantName(r.tenant_id)}</td>
