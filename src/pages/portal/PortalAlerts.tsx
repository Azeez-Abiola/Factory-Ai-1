    ...
    <>
      ...
      <Card className="p-4 flex flex-col gap-3 md:flex-row md:items-center">
        ...
        <Select value={severity} onValueChange={setSeverity}>
          <SelectTrigger className="h-10 md:w-[150px]" aria-label="Severity"><SelectValue /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={status} onValueChange={setStatus}>
          <SelectTrigger className="h-10 md:w-[150px]" aria-label="Status"><SelectValue /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={range} onValueChange={setRange}>
          <SelectTrigger className="h-10 md:w-[150px]" aria-label="Time range"><SelectValue /></SelectTrigger>
          <SelectContent>
